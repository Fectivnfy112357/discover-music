...
public final class FlowKt__LimitKt$take$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__LimitKt$take$$inlined$unsafeFlow$1", f = "Limit.kt", i = {0}, l = {UMErrorCode.E_UM_BE_DEFLATE_FAILED}, m = "collect", n = {"ownershipMarker"}, s = {"L$0"})
