...
final /* synthetic */ class FlowKt__LimitKt {
    ...
    */
    ...
    static final class C02591<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        C02591(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3, Continuation<? super C02591> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02591 c02591 = new C02591(this.$this_transformWhile, this.$transform, continuation);
            c02591.L$0 = obj;
            return c02591;
        }
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
            return ((C02591) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T, R> Flow<R> transformWhile(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3) {
        return FlowKt.flow(new C02591(flow, function3, null));
    }
