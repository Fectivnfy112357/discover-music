...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    static final class C02601<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C02601(Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super C02601> continuation) {
            super(3, continuation);
            this.$transform = function2;
        }
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
            C02601 c02601 = new C02601(this.$transform, continuation);
            c02601.L$0 = flowCollector;
            c02601.L$1 = t;
            return c02601.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T, R> Flow<R> mapLatest(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        return FlowKt.transformLatest(flow, new C02601(function2, null));
    }
