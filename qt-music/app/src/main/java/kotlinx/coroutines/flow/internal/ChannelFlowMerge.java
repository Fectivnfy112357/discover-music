...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    static final class AnonymousClass2<T> implements FlowCollector {
        ...
        */
        ...
        @DebugMetadata(c = "kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1", f = "Merge.kt", i = {}, l = {CharsetProber.ASCII_A_CAPITAL}, m = "invokeSuspend", n = {}, s = {})
