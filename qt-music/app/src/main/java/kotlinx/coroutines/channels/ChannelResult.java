...
public final class ChannelResult<T> {
    ...
    public boolean equals(Object other) {
        return m2524equalsimpl(this.holder, other);
    }
    ...
    public static final T m2528getOrThrowimpl(Object obj) throws Throwable {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final class Companion {
        ...
        public final <E> Object m2537successJP2dKIU(E value) {
            return ChannelResult.m2523constructorimpl(value);
        }
        ...
        public final <E> Object m2535closedJP2dKIU(Throwable cause) {
            return ChannelResult.m2523constructorimpl(new Closed(cause));
        }
    }
