...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2541trySendImplMj0NB7M = conflatedBufferedChannel.m2541trySendImplMj0NB7M(e, true);
        if (objM2541trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2526exceptionOrNullimpl(objM2541trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2541trySendImplMj0NB7M = conflatedBufferedChannel.m2541trySendImplMj0NB7M(e, true);
        if (!(objM2541trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2507trySendJP2dKIU(E element) {
        return m2541trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2541trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2540trySendDropLatestMj0NB7M(element, isSendOp) : m2516trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2540trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2507trySendJP2dKIU = super.mo2507trySendJP2dKIU(element);
        if (ChannelResult.m2532isSuccessimpl(objMo2507trySendJP2dKIU) || ChannelResult.m2530isClosedimpl(objMo2507trySendJP2dKIU)) {
            return objMo2507trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2507trySendJP2dKIU = mo2507trySendJP2dKIU(element);
        if (!(objMo2507trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2507trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2526exceptionOrNullimpl(objMo2507trySendJP2dKIU);
