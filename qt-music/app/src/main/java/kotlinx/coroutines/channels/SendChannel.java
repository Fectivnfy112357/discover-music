...
public interface SendChannel<E> {
    ...
    Object mo2507trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2532isSuccessimpl(objMo2507trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2526exceptionOrNullimpl = ChannelResult.m2526exceptionOrNullimpl(objMo2507trySendJP2dKIU);
