...
public interface ReceiveChannel<E> {
    ...
    Object mo2514receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo2515tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2515tryReceivePtdJZtk = receiveChannel.mo2515tryReceivePtdJZtk();
            if (ChannelResult.m2532isSuccessimpl(objMo2515tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2528getOrThrowimpl(objMo2515tryReceivePtdJZtk);
            }
            Throwable thM2526exceptionOrNullimpl = ChannelResult.m2526exceptionOrNullimpl(objMo2515tryReceivePtdJZtk);
            if (thM2526exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2526exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo2514receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
