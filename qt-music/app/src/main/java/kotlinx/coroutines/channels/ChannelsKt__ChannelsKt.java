...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                ...
                objM1001constructorimpl = Result.m1001constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM1001constructorimpl = Result.m1001constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m2522boximpl(Result.m1008isSuccessimpl(objM1001constructorimpl) ? ChannelResult.INSTANCE.m2537successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2535closedJP2dKIU(Result.m1004exceptionOrNullimpl(objM1001constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2507trySendJP2dKIU = sendChannel.mo2507trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m2532isSuccessimpl(sendChannel.mo2507trySendJP2dKIU(obj))) {
            return;
        }
