...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2514receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2514receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2515tryReceivePtdJZtk() {
        return this._channel.mo2515tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2507trySendJP2dKIU(E e) {
        return this._channel.mo2507trySendJP2dKIU(e);
    }
