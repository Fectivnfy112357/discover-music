...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2574scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2495delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2496toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2496toDelayMillisLRDsOJo(long j) {
        boolean zM2362isPositiveimpl = Duration.m2362isPositiveimpl(j);
        if (zM2362isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m2346getInWholeMillisecondsimpl(Duration.m2364plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM2362isPositiveimpl) {
