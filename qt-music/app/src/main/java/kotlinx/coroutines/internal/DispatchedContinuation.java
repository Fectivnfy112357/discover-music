...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(getContext())) {
            this._state = state;
            this.resumeMode = 0;
            this.dispatcher.mo2573dispatch(getContext(), this);
            return;
        }
    ...
    */
    public final void resumeCancellableWith$kotlinx_coroutines_core(java.lang.Object r8) {
        ...
        L3e:
            ...
            java.lang.Object r8 = kotlin.Result.m1001constructorimpl(r8)     // Catch: java.lang.Throwable -> Lc2
    ...
    public final boolean resumeCancelled$kotlinx_coroutines_core(Object state) {
        ...
        resumeWith(Result.m1001constructorimpl(ResultKt.createFailure(cancellationException)));
        return true;
    }
