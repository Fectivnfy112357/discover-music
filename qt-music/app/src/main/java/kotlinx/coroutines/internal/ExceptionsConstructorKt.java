...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM1001constructorimpl = Result.m1001constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM1001constructorimpl;
        }
    ...
    public static final Throwable safeCtor$lambda$9(Function1 function1, Throwable th) {
        ...
        try {
            ...
            objM1001constructorimpl = Result.m1001constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1001constructorimpl = Result.m1001constructorimpl(ResultKt.createFailure(th3));
        }
        return (Throwable) (Result.m1007isFailureimpl(objM1001constructorimpl) ? null : objM1001constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM1001constructorimpl = Result.m1001constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1001constructorimpl = Result.m1001constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m1007isFailureimpl(objM1001constructorimpl)) {
            objM1001constructorimpl = numValueOf;
        }
        return ((Number) objM1001constructorimpl).intValue();
    }
