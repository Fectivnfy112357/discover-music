...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo2574scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo2574scheduleResumeAfterDelay(timeMillis, continuation);
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (i >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo2573dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
    ...
    public void mo2573dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo2573dispatch(this, new Worker(runnableObtainTaskOrDeallocateWorker));
    }
