...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM1001constructorimpl2;
        ...
        try {
            ...
            objM1001constructorimpl = Result.m1001constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1001constructorimpl = Result.m1001constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m1004exceptionOrNullimpl(objM1001constructorimpl) == null) {
            obj2 = objM1001constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM1001constructorimpl2 = Result.m1001constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM1001constructorimpl2 = Result.m1001constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m1004exceptionOrNullimpl(objM1001constructorimpl2) == null) {
            obj = objM1001constructorimpl2;
        }
