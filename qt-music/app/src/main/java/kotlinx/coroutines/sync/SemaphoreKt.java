...
public final class SemaphoreKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.sync.SemaphoreKt", f = "Semaphore.kt", i = {0, 0}, l = {81}, m = "withPermit", n = {"$this$withPermit", a.t}, s = {"L$0", "L$1"})
