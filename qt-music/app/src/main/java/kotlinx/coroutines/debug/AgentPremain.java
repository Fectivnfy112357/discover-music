...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM1001constructorimpl = Result.m1001constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1001constructorimpl = Result.m1001constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m1007isFailureimpl(objM1001constructorimpl) ? null : objM1001constructorimpl);
