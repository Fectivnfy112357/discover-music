...
public final class RoundedCornersTransformation implements Transformation {
    ...
    public Object transform(Bitmap bitmap, Size size, Continuation<? super Bitmap> continuation) {
        ...
        Bitmap bitmapCreateBitmap = Bitmap.createBitmap(pairCalculateOutputSize.component1().intValue(), pairCalculateOutputSize.component2().intValue(), Bitmaps.getSafeConfig(bitmap));
