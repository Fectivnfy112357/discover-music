...
final class ContinuationCallback implements Callback, Function1<Throwable, Unit> {
    ...
    public void onResponse(Call call, Response response) {
        ...
        cancellableContinuation.resumeWith(Result.m1001constructorimpl(response));
    }
    ...
    public void onFailure(Call call, IOException e) {
        ...
        CancellableContinuation<Response> cancellableContinuation = this.continuation;
        Result.Companion companion = Result.INSTANCE;
        cancellableContinuation.resumeWith(Result.m1001constructorimpl(ResultKt.createFailure(e)));
    }
