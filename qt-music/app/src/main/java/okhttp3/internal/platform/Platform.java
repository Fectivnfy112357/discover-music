...
public class Platform {
    ...
    public X509TrustManager trustManager(SSLSocketFactory sslSocketFactory) {
        ...
        try {
            ...
            Object fieldOrNull = Util.readFieldOrNull(sslSocketFactory, sslContextClass, f.X);
            if (fieldOrNull == null) {
                return null;
            }
