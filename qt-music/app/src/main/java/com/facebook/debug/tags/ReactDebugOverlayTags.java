...
public class ReactDebugOverlayTags {
    ...
    public static final DebugOverlayTag NAVIGATION = new DebugOverlayTag("Navigation", "Tag for navigation", Color.rgb(VbriFrame.MAX_BUFFER_SIZE_NEEDED_TO_READ_VBRI, 39, 176));
