    ...
    private void resetCurrentContext(ReactContext reactContext) {
        ...
        if (this.mCurrentContext != null) {
            try {
                ...
                ((HMRClient) this.mCurrentContext.getJSModule(HMRClient.class)).setup(MusicService.ANDROID_OPTIONS_KEY, url.getPath().substring(1), url.getHost(), url.getPort() != -1 ? url.getPort() : url.getDefaultPort(), this.mDevSettings.isHotModuleReplacementEnabled());
    ...
    public void reload() {
        ...
        if (this.mIsDevSupportEnabled) {
            ...
            if (!this.mIsShakeDetectorStarted) {
                this.mShakeDetector.start((SensorManager) this.mApplicationContext.getSystemService(bm.ac));
