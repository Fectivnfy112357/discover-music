...
public class ReactSurfaceImpl implements ReactSurface {
    ...
    public void attach(ReactHostImpl reactHostImpl) {
        if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.mReactHost, null, reactHostImpl)) {
            throw new IllegalStateException("This surface is already attached to a host!");
        }
    }

    public void attachView(ReactSurfaceView reactSurfaceView) {
        if (!LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(this.mSurfaceView, null, reactSurfaceView)) {
