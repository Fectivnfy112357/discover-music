...
public final class PropsAnimatedNode extends AnimatedNode {
    ...
    public final View getConnectedView() {
        ...
        try {
            ...
            UIManager uIManager = this.connectedViewUIManager;
            objM1001constructorimpl = Result.m1001constructorimpl(uIManager != null ? uIManager.resolveView(this.connectedViewTag) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1001constructorimpl = Result.m1001constructorimpl(ResultKt.createFailure(th));
        }
        return (View) (Result.m1007isFailureimpl(objM1001constructorimpl) ? null : objM1001constructorimpl);
    }
