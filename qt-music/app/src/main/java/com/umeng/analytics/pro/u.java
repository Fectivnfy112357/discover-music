    ...
    public void a(String str, Map<String, Object> map, long j, String str2, boolean z) {
        try {
            ...
            if (b(map)) {
                ...
                String strD = UMUtils.isMainProgress(g) ? aa.a().d(UMGlobalContext.getAppContext(g)) : aa.a().a(UMGlobalContext.getAppContext(g), jSONObject.getLong("ts"));
                ...
                if (z) {
                    Context context = g;
                    UMWorkDispatch.sendEvent(context, q.a.n, CoreProtocol.getInstance(context), jSONObject);
                } else {
                    Context context2 = g;
