    ...
    */
    ...
    public void deleteMainProcessEventDatasByIds(List<Integer> list) {
        ...
        try {
            ...
            while (it.hasNext()) {
                sQLiteDatabaseA.delete(a.InterfaceC0037a.a, "id=?", new String[]{String.valueOf(it.next())});
            }
    ...
    public void deleteEventDatas(String str, String str2, List<a> list) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                int size = list.size();
                if (list == null || size <= 0) {
                    sQLiteDatabaseA.delete(a.InterfaceC0037a.a, null, null);
                } else {
            ...
            try {
                ...
                for (a aVar : list) {
                    try {
                        ...
                        contentValues.put(a.InterfaceC0037a.f, aVar.f);
                        contentValues.put("__av", aVar.g);
                        contentValues.put("__vc", aVar.h);
                        contentValues.put("__s", aVar.d);
                        sQLiteDatabaseA.insert(a.InterfaceC0037a.a, null, contentValues);
                    } catch (Exception unused2) {
                    }
                }
                sQLiteDatabaseA.setTransactionSuccessful();
    ...
    public JSONObject readVersionInfoFromColumId(Integer num) throws Throwable {
        ...
        try {
            ...
            try {
                try {
                    sQLiteDatabaseA.beginTransaction();
                    Cursor cursorQuery = sQLiteDatabaseA.query(a.InterfaceC0037a.a, null, "rowid=?", new String[]{String.valueOf(num)}, null, null, null);
                    if (cursorQuery != null) {
                        try {
                            try {
    ...
    */
    private java.util.List<com.umeng.analytics.process.UMProcessDBHelper.a> readEventByProcess(java.lang.String r13) throws java.lang.Throwable {
        ...
        L22:
            ...
            int r5 = r3.getColumnIndex(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lbb
            java.lang.String r5 = r3.getString(r5)     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lbb
            r4.c = r5     // Catch: java.lang.Exception -> L8c java.lang.Throwable -> Lbb
