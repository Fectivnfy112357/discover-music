...
public class ABTest implements d {
    ...
    public static synchronized ABTest getService(Context context) {
        if (instance == null) {
            instance = new ABTest(context, UMEnvelopeBuild.imprintProperty(context, "client_test", null), Integer.valueOf(UMEnvelopeBuild.imprintProperty(context, "test_report_interval", SessionDescription.SUPPORTED_SDP_VERSION)).intValue());
        }
        return instance;
    }
    ...
    public void onImprintChanged(ImprintHandler.a aVar) {
        onExperimentChanged(aVar.a("client_test", null), Integer.valueOf(aVar.a("test_report_interval", SessionDescription.SUPPORTED_SDP_VERSION)).intValue());
    }
