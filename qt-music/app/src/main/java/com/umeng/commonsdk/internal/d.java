...
public class d {
    ...
    public static JSONArray g(Context context) throws JSONException {
        ...
        if (context != null && (listF = com.umeng.commonsdk.internal.utils.a.f((applicationContext = context.getApplicationContext()))) != null && !listF.isEmpty()) {
            for (a.C0041a c0041a : listF) {
                if (c0041a != null) {
                    try {
                        JSONObject jSONObject = new JSONObject();
                        jSONObject.put("a_pn", c0041a.a);
                        jSONObject.put("a_la", c0041a.b);
                        jSONObject.put("ts", System.currentTimeMillis());
                        jSONArray.put(jSONObject);
                    } catch (Exception e) {
                        UMCrashManager.reportCrash(applicationContext, e);
    ...
    public static JSONObject h(Context context) throws JSONException {
        ...
        if (context != null && (memoryInfoG = com.umeng.commonsdk.internal.utils.a.g((applicationContext = context.getApplicationContext()))) != null) {
            try {
                jSONObject.put(bm.aM, memoryInfoG.totalMem);
                jSONObject.put("f", memoryInfoG.availMem);
                jSONObject.put("ts", System.currentTimeMillis());
            } catch (Exception e) {
                UMCrashManager.reportCrash(applicationContext, e);
            }
