...
public class c implements UMLogDataProtocol {
    ...
    private Context e;
    public static final String a = aw.b().b(aw.q);
    ...
    private void a(Context context) {
        try {
            ...
            jSONObject.put(com.umeng.commonsdk.statistics.b.a(bm.x), "Android");
    ...
    private void d() {
        ...
        if (bpVarA != null) {
            ...
            try {
                ...
                JSONObject jSONObjectA = new com.umeng.commonsdk.statistics.b().a(this.e.getApplicationContext(), new JSONObject(bpVarA.c), new JSONObject(bpVarA.d), bpVarA.e, str2, bpVarA.f);
    ...
    */
    public void workEvent(java.lang.Object r11, int r12) throws org.json.JSONException, java.lang.IllegalAccessException, java.lang.ClassNotFoundException, java.lang.IllegalArgumentException, java.lang.reflect.InvocationTargetException {
        /*
