...
public class UMConfigure {
    ...
    public static void init(Context context, int i, String str) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
    ...
    private static void preInitInternal(Context context, String str, String str2) {
        ...
        if ("1".equals(UMUtils.getSystemProperty("debug.umeng.rtlog", SessionDescription.SUPPORTED_SDP_VERSION))) {
            shouldOutputRT = true;
        }
    ...
    /* JADX WARN: Type inference failed for: r8v28, types: [com.umeng.commonsdk.UMConfigure$3] */
    /* JADX WARN: Type inference failed for: r8v34, types: [com.umeng.commonsdk.UMConfigure$2] */
    /* JADX WARN: Type inference failed for: r8v38, types: [com.umeng.commonsdk.UMConfigure$1] */
    public static void init(Context context, String str, String str2, int i, String str3) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        ...
        try {
            try {
                if (debugLog) {
                    Log.i(TAG, "common version is 9.6.8");
    ...
    public static boolean needSendZcfgEnv(Context context) {
        return !new File(new StringBuilder().append(context.getFilesDir().getAbsolutePath()).append(File.separator).append(bq.l).toString()).exists();
    }

    private static boolean needCheckPolicyResult(Context context) {
        return !new File(new StringBuilder().append(context.getFilesDir().getAbsolutePath()).append(File.separator).append(bq.m).toString()).exists();
    }
    ...
    public static void getOaid(Context context, OnGetOaidListener onGetOaidListener) {
        if (context == null) {
            ...
            new Thread(new Runnable() { // from class: com.umeng.commonsdk.UMConfigure.4
                ...
                public void run() {
                    String strB = ay.b(applicationContext);
