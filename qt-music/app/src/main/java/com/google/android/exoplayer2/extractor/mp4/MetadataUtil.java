        ...
        try {
            if (i2 == TYPE_TOP_BYTE_COPYRIGHT || i2 == TYPE_TOP_BYTE_REPLACEMENT) {
                ...
                if (i3 == SHORT_TYPE_YEAR) {
                    return parseTextAttribute(i, ID3v24Frames.FRAME_ID_YEAR, parsableByteArray);
                }
