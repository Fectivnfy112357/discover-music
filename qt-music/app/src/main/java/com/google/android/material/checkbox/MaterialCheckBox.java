...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    private static final int FRAMEWORK_BUTTON_DRAWABLE_RES_ID = Resources.getSystem().getIdentifier("btn_check_material_anim", "drawable", MusicService.ANDROID_OPTIONS_KEY);
