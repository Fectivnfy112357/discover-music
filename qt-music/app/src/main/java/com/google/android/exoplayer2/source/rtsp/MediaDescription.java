...
final class MediaDescription {
    ...
    public static final class RtpMapAttribute {
        ...
        public static RtpMapAttribute parse(String str) throws ParserException, NumberFormatException {
    ...
    public static final class Builder {
        ...
        public MediaDescription build() throws NumberFormatException {
    ...
    public int hashCode() {
        int iHashCode = (((((((((((((JfifUtil.MARKER_EOI + this.mediaType.hashCode()) * 31) + this.port) * 31) + this.transportProtocol.hashCode()) * 31) + this.payloadType) * 31) + this.bitrate) * 31) + this.attributes.hashCode()) * 31) + this.rtpMapAttribute.hashCode()) * 31;
