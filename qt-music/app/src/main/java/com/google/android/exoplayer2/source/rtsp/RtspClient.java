...
final class RtspClient implements Closeable {
    ...
    public void maybeLogMessage(List<String> list) {
        if (this.debugLoggingEnabled) {
            Log.d(TAG, Joiner.on(ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE).join(list));
        }
    }
    ...
    final class MessageListener implements RtspMessageChannel.MessageListener {
        ...
        public void m803xbc9c051a(List<String> list) throws ParserException, NumberFormatException {
            ...
            try {
                try {
                    ...
                    if (i3 == 461) {
                        ...
                        if (i2 == 10 && !str6.contains(ID3v22Frames.FRAME_ID_V2_IS_COMPILATION)) {
