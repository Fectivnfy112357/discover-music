...
public interface AudioRendererEventListener {
    ...
    public static final class EventDispatcher {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.audio.AudioRendererEventListener$EventDispatcher$$ExternalSyntheticLambda6
                    ...
                    public final void run() {
                        this.f$0.m744x5024e2cf(decoderCounters);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m744x5024e2cf(DecoderCounters decoderCounters) {
        ...
        public void decoderInitialized(final String str, final long j, final long j2) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.audio.AudioRendererEventListener$EventDispatcher$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m741x34ee4b45(str, j, j2);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m741x34ee4b45(String str, long j, long j2) {
        ...
        public void inputFormatChanged(final Format format, final DecoderReuseEvaluation decoderReuseEvaluation) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.audio.AudioRendererEventListener$EventDispatcher$$ExternalSyntheticLambda8
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m745xd066461(format, decoderReuseEvaluation);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m745xd066461(Format format, DecoderReuseEvaluation decoderReuseEvaluation) {
        ...
        /* synthetic */ void m746x4b664277(long j) {
        ...
        /* synthetic */ void m748x69131a3f(int i, long j, long j2) {
        ...
        /* synthetic */ void m742x97e584ca(String str) {
        ...
        public void disabled(final DecoderCounters decoderCounters) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.audio.AudioRendererEventListener$EventDispatcher$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m743xa9a48754(decoderCounters);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m743xa9a48754(DecoderCounters decoderCounters) {
            decoderCounters.ensureUpdated();
        ...
        /* synthetic */ void m747x9104d974(boolean z) {
        ...
        /* synthetic */ void m740xcf2a89af(Exception exc) {
        ...
        /* synthetic */ void m739x305f60bf(Exception exc) {
