...
public class DefaultDashChunkSource implements DashChunkSource {
    ...
    public void getNextChunk(long j, long j2, List<? extends MediaChunk> list, ChunkHolder chunkHolder) {
        ...
        if (playerTrackEmsgHandler == null || !playerTrackEmsgHandler.maybeRefreshManifestBeforeLoadingNextChunk(jMsToUs)) {
            ...
            chunkHolder.chunk = newMediaChunk(representationHolderUpdateSelectedBaseUrl, this.dataSource, this.trackType, this.trackSelection.getSelectedFormat(), this.trackSelection.getSelectionReason(), this.trackSelection.getSelectionData(), segmentNum2, i4, list.isEmpty() ? j2 : -9223372036854775807L, nowPeriodTimeUs, cmcdConfiguration == null ? null : CmcdLog.createInstance(cmcdConfiguration, this.trackSelection, j, j2));
        }
    }
    ...
    protected Chunk newMediaChunk(RepresentationHolder representationHolder, DataSource dataSource, int i, Format format, int i2, Object obj, long j, int i3, long j2, long j3, CmcdLog cmcdLog) {
        Representation representation = representationHolder.representation;
        ...
        ImmutableMap<String, String> immutableMapOf = cmcdLog == null ? ImmutableMap.of() : cmcdLog.getHttpRequestHeaders();
        if (representationHolder.chunkExtractor == null) {
            return new SingleSampleMediaChunk(dataSource, DashUtil.buildDataSpec(representation, representationHolder.selectedBaseUrl.url, segmentUrl, representationHolder.isSegmentAvailableAtFullNetworkSpeed(j, j3) ? 0 : 8).buildUpon().setHttpRequestHeaders(immutableMapOf).build(), format, i2, obj, segmentStartTimeUs, representationHolder.getSegmentEndTimeUs(j), j, i, format);
        }
        int i4 = 1;
        int i5 = 1;
        while (i4 < i3) {
