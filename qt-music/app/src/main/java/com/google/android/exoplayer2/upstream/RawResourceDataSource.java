...
public final class RawResourceDataSource extends BaseDataSource {
    ...
    public long open(DataSpec dataSpec) throws DataSourceException, Resources.NotFoundException, NumberFormatException {
        ...
        if (TextUtils.equals("rawresource", uriNormalizeScheme.getScheme()) || (TextUtils.equals(UriUtil.QUALIFIED_RESOURCE_SCHEME, uriNormalizeScheme.getScheme()) && uriNormalizeScheme.getPathSegments().size() == 1 && ((String) Assertions.checkNotNull(uriNormalizeScheme.getLastPathSegment())).matches("\\d+"))) {
            try {
