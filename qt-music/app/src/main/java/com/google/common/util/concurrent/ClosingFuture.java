...
public final class ClosingFuture<V> {
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this).add(MusicService.STATE_KEY, this.state.get()).addValue(this.future).toString();
    }
    ...
    static /* synthetic */ void lambda$closeQuietly$0(AutoCloseable autoCloseable) throws Exception {
        try {
            autoCloseable.close();
        } catch (Exception e) {
