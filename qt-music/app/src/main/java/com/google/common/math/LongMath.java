...
public final class LongMath {
    ...
    static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, 206, 169, EUCJPContextAnalysis.SINGLE_SHIFT_3, 125, UMErrorCode.E_UM_BE_CREATE_FAILED, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, 419, 287, 214, 169, TsExtractor.TS_STREAM_TYPE_DTS_UHD, 119, c.e, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    public static double roundToDouble(long x, RoundingMode mode) {
        ...
        double d = x;
        long jFloor = (long) d;
        int iCompare = jFloor == Long.MAX_VALUE ? -1 : Long.compare(x, jFloor);
        switch (AnonymousClass1.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
            case 1:
