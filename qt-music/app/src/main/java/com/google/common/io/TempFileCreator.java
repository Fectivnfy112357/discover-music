    ...
    static final class JavaNioCreator extends TempFileCreator {
        ...
        private static String getUsername() throws NoSuchMethodException, ClassNotFoundException, SecurityException {
            ...
            try {
                ...
                Method method = cls.getMethod(InstrumentationResultPrinter.REPORT_KEY_NUM_CURRENT, new Class[0]);
                return (String) Objects.requireNonNull(cls3.getMethod("orElse", Object.class).invoke(cls2.getMethod(aw.m, new Class[0]).invoke(cls.getMethod("info", new Class[0]).invoke(method.invoke(null, new Object[0]), new Object[0]), new Object[0]), str));
            } catch (ClassNotFoundException unused) {
                return str;
