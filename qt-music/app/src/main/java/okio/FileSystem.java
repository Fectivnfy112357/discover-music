...
public abstract class FileSystem {
    ...
    public static /* synthetic */ Object m2735write$default(FileSystem fileSystem, Path file, boolean z, Function1 writerAction, int i, Object obj) throws IOException {
        ?? r4;
        if (obj == null) {
            if ((i & 2) != 0) {
                z = false;
    ...
    public final <T> T m2736read(Path file, Function1<? super BufferedSource, ? extends T> readerAction) throws IOException {
        ?? r6;
        Intrinsics.checkNotNullParameter(file, "file");
    ...
    public final <T> T m2737write(Path file, boolean mustCreate, Function1<? super BufferedSink, ? extends T> writerAction) throws IOException {
        ?? r6;
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
