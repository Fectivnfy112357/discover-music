...
public final class C0278SegmentedByteString extends ByteString {
    ...
    public C0278SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        C0278SegmentedByteString c0278SegmentedByteString = this;
        int iResolveDefaultParameter = SegmentedByteString.resolveDefaultParameter(c0278SegmentedByteString, endIndex);
        if (beginIndex < 0) {
        ...
        if (beginIndex == 0 && iResolveDefaultParameter == size()) {
            return c0278SegmentedByteString;
        }
