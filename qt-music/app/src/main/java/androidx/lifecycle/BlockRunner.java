...
public final class BlockRunner<T> {
    ...
    public final void maybeRun() {
        ...
        this.runningJob = BuildersKt__Builders_commonKt.launch$default(this.scope, null, null, new C00821(this, null), 3, null);
    }
    ...
    static final class C00821 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C00821(BlockRunner<T> blockRunner, Continuation<? super C00821> continuation) {
