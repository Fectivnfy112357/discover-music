        ...
        if ((widgetRun instanceof HorizontalWidgetRun) || (((z = widgetRun instanceof ChainRun)) && ((ChainRun) widgetRun).orientation == 0)) {
            ...
            if (horizontalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.FIXED || horizontalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
                if (!dependencyNode.targets.isEmpty() && dependencyNode2.targets.isEmpty()) {
                    strGenerateDisplayNode = strGenerateDisplayNode + (ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + dependencyNode2.name() + " -> " + dependencyNode.name() + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
                } else if (dependencyNode.targets.isEmpty() && !dependencyNode2.targets.isEmpty()) {
                    strGenerateDisplayNode = strGenerateDisplayNode + (ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + dependencyNode.name() + " -> " + dependencyNode2.name() + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
                }
                ...
                String debugName = widgetRun.widget.getDebugName();
                String str3 = ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + debugName + "_HORIZONTAL -> " + debugName + "_VERTICAL;\n";
            }
            ...
            if (verticalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.FIXED || verticalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
                ...
                String str4 = ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + debugName2 + "_VERTICAL -> " + debugName2 + "_HORIZONTAL;\n";
            }
        }
