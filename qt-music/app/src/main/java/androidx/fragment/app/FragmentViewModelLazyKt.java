...
public final class FragmentViewModelLazyKt {
    public static /* synthetic */ Lazy viewModels$default(final Fragment fragment, Function0 ownerProducer, Function0 function0, int i, Object obj) {
        ...
        C00772 c00772 = new C00772(lazy);
        C00783 c00783 = new C00783(lazy);
        if (function0 == null) {
            function0 = new C00794(fragment, lazy);
        }
        return createViewModelLazy(fragment, orCreateKotlinClass, c00772, c00783, function0);
    }
    ...
    public static final ViewModelStoreOwner m56viewModels$lambda0(Lazy<? extends ViewModelStoreOwner> lazy) {
    ...
    public static final class C00772 extends Lambda implements Function0<ViewModelStore> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C00772(Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
        ...
        public final ViewModelStore invoke() {
            return FragmentViewModelLazyKt.m56viewModels$lambda0(this.$owner$delegate).getViewModelStore();
        }
    }
    ...
    public static final class C00783 extends Lambda implements Function0<CreationExtras> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C00783(Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
            this.$owner$delegate = lazy;
        }
        ...
        public final CreationExtras invoke() {
            ...
            ViewModelStoreOwner viewModelStoreOwnerM56viewModels$lambda0 = FragmentViewModelLazyKt.m56viewModels$lambda0(this.$owner$delegate);
            HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = viewModelStoreOwnerM56viewModels$lambda0 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) viewModelStoreOwnerM56viewModels$lambda0 : null;
    ...
    public static final class C00794 extends Lambda implements Function0<ViewModelProvider.Factory> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;
        final /* synthetic */ Fragment $this_viewModels;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C00794(Fragment fragment, Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
    ...
    public static /* synthetic */ Lazy viewModels$default(final Fragment fragment, Function0 ownerProducer, Function0 function0, Function0 function02, int i, Object obj) {
        ...
        Intrinsics.reifiedOperationMarker(4, "VM");
        KClass orCreateKotlinClass = Reflection.getOrCreateKotlinClass(ViewModel.class);
        C00816 c00816 = new C00816(lazy);
        AnonymousClass7 anonymousClass7 = new AnonymousClass7(function0, lazy);
        if (function02 == null) {
            function02 = new AnonymousClass8(fragment, lazy);
        }
        return createViewModelLazy(fragment, orCreateKotlinClass, c00816, anonymousClass7, function02);
    }
    ...
    public static final ViewModelStoreOwner m57viewModels$lambda1(Lazy<? extends ViewModelStoreOwner> lazy) {
        return lazy.getValue();
    }
    ...
    public static final class C00816 extends Lambda implements Function0<ViewModelStore> {
        final /* synthetic */ Lazy<ViewModelStoreOwner> $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C00816(Lazy<? extends ViewModelStoreOwner> lazy) {
            super(0);
            this.$owner$delegate = lazy;
        }
        ...
        @Override // kotlin.jvm.functions.Function0
        public final ViewModelStore invoke() {
            return FragmentViewModelLazyKt.m57viewModels$lambda1(this.$owner$delegate).getViewModelStore();
        }
    }
    ...
    public static final class AnonymousClass7 extends Lambda implements Function0<CreationExtras> {
        ...
        public final CreationExtras invoke() {
            ...
            ViewModelStoreOwner viewModelStoreOwnerM57viewModels$lambda1 = FragmentViewModelLazyKt.m57viewModels$lambda1(this.$owner$delegate);
            HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = viewModelStoreOwnerM57viewModels$lambda1 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) viewModelStoreOwnerM57viewModels$lambda1 : null;
