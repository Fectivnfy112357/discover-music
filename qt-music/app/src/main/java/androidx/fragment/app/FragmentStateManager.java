...
class FragmentStateManager {
    ...
    Bundle saveState() {
        ...
        if (this.mFragment.mState > -1) {
            ...
            Bundle bundleM49lambda$attachController$4$androidxfragmentappFragmentManager = this.mFragment.mChildFragmentManager.m49lambda$attachController$4$androidxfragmentappFragmentManager();
            if (!bundleM49lambda$attachController$4$androidxfragmentappFragmentManager.isEmpty()) {
                bundle.putBundle(CHILD_FRAGMENT_MANAGER_KEY, bundleM49lambda$attachController$4$androidxfragmentappFragmentManager);
            }
            if (this.mFragment.mView != null) {
                saveViewState();
            }
