    ...
    public FragmentedMp4Extractor(SubtitleParser.Factory factory, int i, TimestampAdjuster timestampAdjuster, Track track, List<Format> list, TrackOutput trackOutput) {
        ...
        this.reorderingSeiMessageQueue = new ReorderingSeiMessageQueue(new ReorderingSeiMessageQueue.SeiConsumer() { // from class: androidx.media3.extractor.mp4.FragmentedMp4Extractor$$ExternalSyntheticLambda3
            ...
            public final void consume(long j, ParsableByteArray parsableByteArray) {
                this.f$0.m198x40e97494(j, parsableByteArray);
            }
        });
    }

    /* renamed from: lambda$new$2$androidx-media3-extractor-mp4-FragmentedMp4Extractor, reason: not valid java name */
    /* synthetic */ void m198x40e97494(long j, ParsableByteArray parsableByteArray) {
        ...
        if (track.nalUnitLengthFieldLength == 0) {
            ...
            while (this.sampleBytesWritten < this.sampleSize) {
                ...
                if (i7 == 0) {
                    ...
                    this.nalPrefix.setPosition(z ? 1 : 0);
                    int i8 = this.nalPrefix.readInt();
                    if (i8 < r9) {
                        throw ParserException.createForMalformedContainer("Invalid NAL length", null);
                    }
                    this.sampleCurrentNalBytesRemaining = i8 - 1;
                    this.nalStartCode.setPosition(z ? 1 : 0);
                    trackOutput.sampleData(this.nalStartCode, i2);
                    trackOutput.sampleData(this.nalPrefix, r9 == true ? 1 : 0);
                    this.processSeiNalUnitPayload = (this.ceaTrackOutputs.length <= 0 || !NalUnitUtil.isNalUnitSei(track.format, data[i2])) ? z ? 1 : 0 : r9 == true ? 1 : 0;
                    this.sampleBytesWritten += 5;
                    this.sampleSize += i6;
                    if (!this.isSampleDependedOn && Objects.equals(nextTrackBundle.moovSampleTable.track.format.sampleMimeType, "video/avc") && NalUnitUtil.isH264NalUnitDependedOn(data[i2])) {
                        this.isSampleDependedOn = r9;
                    }
                } else {
                    if (this.processSeiNalUnitPayload) {
                        this.nalBuffer.reset(i7);
                        extractorInput.readFully(this.nalBuffer.getData(), z ? 1 : 0, this.sampleCurrentNalBytesRemaining);
                        ...
                        this.nalBuffer.setPosition((Objects.equals(track.format.sampleMimeType, "video/hevc") || MimeTypes.containsCodecsCorrespondingToMimeType(track.format.codecs, "video/hevc")) ? 1 : 0);
                        ...
                        i = i2;
                        iSampleData = trackOutput.sampleData(extractorInput, i7, z);
                    }
