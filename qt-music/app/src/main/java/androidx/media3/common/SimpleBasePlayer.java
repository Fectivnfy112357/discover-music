...
public abstract class SimpleBasePlayer extends BasePlayer {
        ...
        public ImmutableList<MediaItemData> getPlaylist() {
            ...
            if (!(timeline instanceof PlaylistTimeline)) {
                ...
                for (int i = 0; i < this.timeline.getWindowCount(); i++) {
                    builderBuilderWithExpectedSize.add((ImmutableList.Builder) MediaItemData.buildFromState(this, i, period, window));
                }
    ...
    protected SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda38
            ...
            public final void invoke(Object obj, FlagSet flagSet) {
                this.f$0.m68lambda$new$0$androidxmedia3commonSimpleBasePlayer((Player.Listener) obj, flagSet);
            }
        });
    }

    /* renamed from: lambda$new$0$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ void m68lambda$new$0$androidxmedia3commonSimpleBasePlayer(Player.Listener listener, FlagSet flagSet) {
    ...
    @RequiresNonNull({MusicService.STATE_KEY})
    private void setMediaItemsInternal(final List<MediaItem> list, final int i, final long j) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i, j), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda28
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m72x396b5ff4(list, state, i, j);
                }
            });
        }
    }
    ...
    /* synthetic */ State m72x396b5ff4(List list, State state, int i, long j) {
    ...
    public final void addMediaItems(int i, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleAddMediaItems(iMin, list), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda34
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m66lambda$addMediaItems$3$androidxmedia3commonSimpleBasePlayer(state, list, iMin);
            }
        });
    }

    /* renamed from: lambda$addMediaItems$3$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m66lambda$addMediaItems$3$androidxmedia3commonSimpleBasePlayer(State state, List list, int i) {
    ...
    public final void moveMediaItems(final int i, int i2, int i3) {
        ...
        updateStateForPendingOperation(handleMoveMediaItems(i, iMin, iMin2), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda48
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m67lambda$moveMediaItems$4$androidxmedia3commonSimpleBasePlayer(state, i, iMin, iMin2);
            }
        });
    }

    /* renamed from: lambda$moveMediaItems$4$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m67lambda$moveMediaItems$4$androidxmedia3commonSimpleBasePlayer(State state, int i, int i2, int i3) {
        List<MediaItemData> listBuildMutablePlaylistFromState = buildMutablePlaylistFromState(state, this.period, this.window);
    ...
    public final void replaceMediaItems(final int i, int i2, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleReplaceMediaItems(i, iMin, list), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda27
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m70x7bc5132c(state, list, iMin, i);
            }
        });
    }

    /* renamed from: lambda$replaceMediaItems$5$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m70x7bc5132c(State state, List list, int i, int i2) {
    ...
    public final void seekTo(final int i, final long j, int i2, boolean z) {
        ...
        if (shouldHandleCommand(i2)) {
            ...
            updateStateForPendingOperation(handleSeek(i, j, i2), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda51
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m71lambda$seekTo$10$androidxmedia3commonSimpleBasePlayer(z3, state, i, j);
                }
            }, !z2, z);
        }
    }
    ...
    /* synthetic */ State m71lambda$seekTo$10$androidxmedia3commonSimpleBasePlayer(boolean z, State state, int i, long j) {
    ...
    public final void stop() {
        ...
        if (shouldHandleCommand(3)) {
            updateStateForPendingOperation(handleStop(), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda54
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m73lambda$stop$12$androidxmedia3commonSimpleBasePlayer(state);
                }
            });
        }
    }
    ...
    /* synthetic */ State m73lambda$stop$12$androidxmedia3commonSimpleBasePlayer(State state) {
    ...
    @EnsuresNonNull({MusicService.STATE_KEY})
    ...
    private void updateStateForPendingOperation(final ListenableFuture<?> listenableFuture, Supplier<State> supplier, boolean z, boolean z2) {
        ...
        listenableFuture.addListener(new Runnable() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda30
            ...
            public final void run() {
                this.f$0.m74x9bf3217a(listenableFuture);
            }
    ...
    /* synthetic */ void m74x9bf3217a(ListenableFuture listenableFuture) {
