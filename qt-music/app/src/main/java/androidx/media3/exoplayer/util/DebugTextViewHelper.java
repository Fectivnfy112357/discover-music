...
public class DebugTextViewHelper {
    ...
    protected String getAudioString() {
        ...
        return ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + audioFormat.sampleMimeType + "(id:" + audioFormat.id + " hz:" + audioFormat.sampleRate + " ch:" + audioFormat.channelCount + getDecoderCountersBufferCountString(audioDecoderCounters) + ")";
    }
