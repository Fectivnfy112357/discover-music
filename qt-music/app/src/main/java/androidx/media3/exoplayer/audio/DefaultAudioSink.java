...
public final class DefaultAudioSink implements AudioSink {
    ...
    public void configure(Format format, int i, int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if (i != 0) {
            ...
            i7 = pcmFrameSize2;
            i8 = i2;
            bufferSizeInBytes = this.audioTrackBufferSizeProvider.getBufferSizeInBytes(getAudioTrackMinBufferSize(i2, iIntValue, i3), i3, i4, pcmFrameSize2 != -1 ? pcmFrameSize2 : 1, i2, i13, z2 ? 8.0d : 1.0d);
        }
    ...
    */
    ...
    private ByteBuffer maybeRampUpVolume(ByteBuffer byteBuffer) {
        ...
        return writtenFrames >= ((long) iDurationUsToSampleCount) ? byteBuffer : PcmAudioUtil.rampUpVolume(byteBuffer, this.configuration.outputEncoding, this.configuration.outputPcmFrameSize, (int) writtenFrames, iDurationUsToSampleCount);
    }
