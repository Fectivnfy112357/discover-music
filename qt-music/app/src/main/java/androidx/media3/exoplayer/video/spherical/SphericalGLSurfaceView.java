...
public final class SphericalGLSurfaceView extends GLSurfaceView {
    ...
    public SphericalGLSurfaceView(Context context, AttributeSet attributeSet) {
        ...
        SensorManager sensorManager = (SensorManager) Assertions.checkNotNull(context.getSystemService(bm.ac));
    ...
    public void onSurfaceTextureAvailable(final SurfaceTexture surfaceTexture) {
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.video.spherical.SphericalGLSurfaceView$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m196x24c550f4(surfaceTexture);
            }
        });
    }
    ...
    /* synthetic */ void m196x24c550f4(SurfaceTexture surfaceTexture) {
