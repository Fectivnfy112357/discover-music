...
public final class LongSparseArrayKt {
    ...
    public static final class C00651<T> implements Iterator<T>, KMappedMarker {
        ...
        C00651(LongSparseArray<T> longSparseArray) {
    ...
    public static final <T> Iterator<T> valueIterator(LongSparseArray<T> longSparseArray) {
        return new C00651(longSparseArray);
    }
