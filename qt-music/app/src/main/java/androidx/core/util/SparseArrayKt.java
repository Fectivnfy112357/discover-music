...
public final class SparseArrayKt {
    ...
    public static final class C00661<T> implements Iterator<T>, KMappedMarker {
        ...
        C00661(SparseArray<T> sparseArray) {
