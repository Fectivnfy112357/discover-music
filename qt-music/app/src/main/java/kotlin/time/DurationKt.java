...
public final class DurationKt {
    ...
    private static final long m2455timesmvk6XK0(int i, long j) {
        return Duration.m2366timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m2454timeskIfJnKk(double d, long j) {
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM2431getZEROUwyO8pc = Duration.INSTANCE.m2431getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i < length) {
                if (str.charAt(i) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM2364plusLRDsOJo = Duration.m2364plusLRDsOJo(jM2431getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM2431getZEROUwyO8pc = Duration.m2364plusLRDsOJo(jM2364plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM2431getZEROUwyO8pc = Duration.m2364plusLRDsOJo(jM2431getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, "Infinity".length()), true)) {
                jM2431getZEROUwyO8pc = Duration.INSTANCE.m2429getINFINITEUwyO8pc();
            } else {
                boolean z7 = !z4;
                ...
                while (length2 < length) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM2364plusLRDsOJo2 = Duration.m2364plusLRDsOJo(jM2431getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM2431getZEROUwyO8pc = Duration.m2364plusLRDsOJo(jM2364plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM2431getZEROUwyO8pc = Duration.m2364plusLRDsOJo(jM2431getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
                    str4 = str6;
        ...
        return z2 ? Duration.m2381unaryMinusUwyO8pc(jM2431getZEROUwyO8pc) : jM2431getZEROUwyO8pc;
    }
    ...
    public static final long durationOf(long j, int i) {
        return Duration.m2328constructorimpl((j << 1) + i);
    }
