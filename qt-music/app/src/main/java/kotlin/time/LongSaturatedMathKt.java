...
public final class LongSaturatedMathKt {
    ...
    public static final long m2457saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM2374toLongimpl = Duration.m2374toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m2456checkInfiniteSumDefinedPjuGub4(j, j2, jM2374toLongimpl);
        }
        if ((1 | (jM2374toLongimpl - 1)) == Long.MAX_VALUE) {
            return m2458saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM2374toLongimpl;
        return ((j ^ j3) & (jM2374toLongimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }

    /* renamed from: checkInfiniteSumDefined-PjuGub4, reason: not valid java name */
    private static final long m2456checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
    ...
    private static final long m2458saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM2331divUwyO8pc = Duration.m2331divUwyO8pc(j2, 2);
        long jM2374toLongimpl = Duration.m2374toLongimpl(jM2331divUwyO8pc, durationUnit);
        return (1 | (jM2374toLongimpl - 1)) == Long.MAX_VALUE ? jM2374toLongimpl : m2457saturatingAddNuflL3o(m2457saturatingAddNuflL3o(j, durationUnit, jM2331divUwyO8pc), durationUnit, Duration.m2363minusLRDsOJo(j2, jM2331divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m2430getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m2429getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m2381unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    public static final long saturatingOriginsDiff(long j, long j2, DurationUnit unit) {
        ...
        if (((j2 - 1) | 1) == Long.MAX_VALUE) {
            if (j == j2) {
                return Duration.INSTANCE.m2431getZEROUwyO8pc();
            }
            return Duration.m2381unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m2364plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m2381unaryMinusUwyO8pc(infinityOfSign(j3));
        }
