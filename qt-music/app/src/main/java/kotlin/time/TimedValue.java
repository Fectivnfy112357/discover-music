...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m2486copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m2488copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m2488copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m2333equalsimpl0(this.duration, timedValue.duration);
    }
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m2377toStringimpl(this.duration)) + ')';
    }
    ...
    public final long m2489getDurationUwyO8pc() {
        return this.duration;
    }
