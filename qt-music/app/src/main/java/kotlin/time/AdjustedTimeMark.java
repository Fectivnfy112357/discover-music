...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo2319minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2465minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo2318elapsedNowUwyO8pc() {
        return Duration.m2363minusLRDsOJo(this.mark.mo2318elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo2321plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2364plusLRDsOJo(this.adjustment, duration), null);
    }
}
