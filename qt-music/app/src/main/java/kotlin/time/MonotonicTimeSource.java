...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2468boximpl(m2462markNowz9LOYto());
    }
    ...
    public long m2462markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2471constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2461elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2460differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2459adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2471constructorimpl(LongSaturatedMathKt.m2457saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
