...
public interface TimeMark {
    ...
    TimeMark mo2319minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo2321plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2466plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2465minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo2321plusLRDsOJo(Duration.m2381unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m2361isNegativeimpl(timeMark.mo2318elapsedNowUwyO8pc());
        }
