...
public final class UnsignedKt {
    ...
    public static final int m1354uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m1097constructorimpl((int) ((i & 4294967295L) % (i2 & 4294967295L)));
    }

    /* renamed from: uintDivide-J1ME1BU, reason: not valid java name */
    public static final int m1353uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m1097constructorimpl((int) ((i & 4294967295L) / (i2 & 4294967295L)));
    }

    /* renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m1355ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? ULong.m1176constructorimpl(0L) : ULong.m1176constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m1176constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m1176constructorimpl(j3 + (Long.compare(ULong.m1176constructorimpl(j - (j3 * j2)) ^ Long.MIN_VALUE, ULong.m1176constructorimpl(j2) ^ Long.MIN_VALUE) < 0 ? 0 : 1));
    }

    /* renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m1356ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? j : ULong.m1176constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m1176constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compare(ULong.m1176constructorimpl(j3) ^ Long.MIN_VALUE, ULong.m1176constructorimpl(j2) ^ Long.MIN_VALUE) < 0) {
            j2 = 0;
        }
        return ULong.m1176constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m1097constructorimpl((int) d);
        }
        return UInt.m1097constructorimpl(UInt.m1097constructorimpl((int) (d - Integer.MAX_VALUE)) + UInt.m1097constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m1176constructorimpl((long) d);
        }
        return ULong.m1176constructorimpl(ULong.m1176constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
