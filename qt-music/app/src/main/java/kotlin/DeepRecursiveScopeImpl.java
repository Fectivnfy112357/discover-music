    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (continuation != null) {
                if (!Result.m1003equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                    this.result = DeepRecursiveKt.UNDEFINED_RESULT;
                    ...
                    try {
                        ...
                        if (objWrapWithContinuationImpl != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            ...
                            continuation.resumeWith(Result.m1001constructorimpl(objWrapWithContinuationImpl));
                        }
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.INSTANCE;
                        continuation.resumeWith(Result.m1001constructorimpl(ResultKt.createFailure(th)));
                    }
                }
            } else {
