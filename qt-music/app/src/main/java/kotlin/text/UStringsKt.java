...
public final class UStringsKt {
    ...
    public static final String m2315toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2317toStringolVBNx4(short s, int i) {
    ...
    public static final String m2316toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(i & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m2314toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m1097constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m1013boximpl(UByte.m1019constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m1097constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m1277boximpl(UShort.m1283constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM1097constructorimpl = UInt.m1097constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM1097constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM1097constructorimpl2 = UInt.m1097constructorimpl(i3 * iM1097constructorimpl);
            int iM1097constructorimpl3 = UInt.m1097constructorimpl(UInt.m1097constructorimpl(iDigitOf) + iM1097constructorimpl2);
            if (Integer.compare(iM1097constructorimpl3 ^ Integer.MIN_VALUE, iM1097constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM1097constructorimpl3;
        }
        return UInt.m1091boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM1176constructorimpl = ULong.m1176constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM1176constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM1176constructorimpl2 = ULong.m1176constructorimpl(j * jM1176constructorimpl);
            long jM1176constructorimpl3 = ULong.m1176constructorimpl(ULong.m1176constructorimpl(UInt.m1097constructorimpl(r13) & 4294967295L) + jM1176constructorimpl2);
            if (Long.compare(jM1176constructorimpl3 ^ Long.MIN_VALUE, jM1176constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM1176constructorimpl3;
        }
        return ULong.m1170boximpl(j);
    }
}
