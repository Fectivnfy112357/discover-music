...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m2210getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM1176constructorimpl = ((int) ULong.m1176constructorimpl(j ^ ULong.m1176constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM1176constructorimpl2 = (iM1176constructorimpl + ((int) ULong.m1176constructorimpl(j2 ^ ULong.m1176constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM1176constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) ULong.m1222toStringimpl(this.first)).append("..").append((Object) ULong.m1222toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) ULong.m1222toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m1222toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m2236fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
