...
public final class Utils_androidKt {
    ...
    public static final boolean isAssetUri(Uri uri) {
        return Intrinsics.areEqual(uri.getScheme(), "file") && Intrinsics.areEqual(kotlin.collections.CollectionsKt.firstOrNull((List) UriKt.getPathSegments(uri)), "android_asset");
    }
