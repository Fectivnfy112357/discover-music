...
public enum ID3v23FieldKey {
    ...
    MASTERING("USLT", FrameBodyTXXX.MASTERING, Id3FieldType.TEXT),
    MASTERING_SORT("USLT", FrameBodyTXXX.MASTERING_SORT, Id3FieldType.TEXT),
    ...
    MOOD("TXXX", FrameBodyTXXX.MOOD, Id3FieldType.TEXT),
    ...
    WORK_PART_LEVEL3_TYPE("TXXX", FrameBodyTXXX.MUSICBRAINZ_WORK_PART_LEVEL3_TYPE, Id3FieldType.TEXT),
    ...
    static Map<String, ID3v23FieldKey> frameIdFieldKeyMapping = new LinkedHashMap();
    ...
    static {
        for (ID3v23FieldKey iD3v23FieldKey : values()) {
            if (iD3v23FieldKey.getSubId() != null) {
                frameIdFieldKeyMapping.put(iD3v23FieldKey.getFrameId() + iD3v23FieldKey.getSubId(), iD3v23FieldKey);
            } else {
                frameIdFieldKeyMapping.put(iD3v23FieldKey.getFrameId(), iD3v23FieldKey);
            }
        }
    }

    ID3v23FieldKey(String str, Id3FieldType id3FieldType) {
        this.frameId = str;
        this.fieldType = id3FieldType;
        this.fieldName = str;
    }

    ID3v23FieldKey(String str, String str2, Id3FieldType id3FieldType) {
        this.frameId = str;
        this.subId = str2;
        this.fieldType = id3FieldType;
    ...
    public static ID3v23FieldKey getFieldKeyFromFrameId(String str) {
