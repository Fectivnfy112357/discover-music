...
public class ISOScript {
    ...
    static {
        ...
        for (Script script2 : Script.values()) {
            descriptionMap.put(script2.description, script2);
        }
    }

    public static Script getScriptByCode(String str) {
        return codeMap.get(str);
    }

    public static Script getScriptByDescription(String str) {
    ...
    public static String[] getDescriptionsAsArray() {
        ...
        for (Script script : Script.values()) {
            arrayList.add(script.description);
        }
