...
public class IdentifierIdClient {
    ...
    public String a(int i2, int i3, int i4, int i5) {
        return new StringBuffer().append(i2).append(",").append(i3).append(";").append(i4).append(",").append(i5).toString();
    }
    ...
    static IdentifierIdClient b(Context context) {
        if (a()) {
            return a(context);
        }
        return null;
    ...
    private static void E() {
        z = "1".equals(a(d, SessionDescription.SUPPORTED_SDP_VERSION)) || "1".equals(a(a, SessionDescription.SUPPORTED_SDP_VERSION));
    }
